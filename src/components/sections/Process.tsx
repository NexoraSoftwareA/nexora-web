...
export default function Process() {
  return (
    <section
      id="proceso"
      className="bg-[#0B0B0B] py-32 text-white"
    >
      <Container>
        ...
        <div className="relative mt-24">
          ...
          <div className="absolute left-1/2 top-0 hidden h-full w-px -translate-x-1/2 bg-gradient-to-b from-blue-500/60 to-transparent lg:block" />
          ...
          <div className="grid gap-10 lg:grid-cols-4">
            ...
            {steps.map((step) => (
              <Reveal key={step.title}>
                ...
                <div className="relative rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl transition-all duration-300 hover:-translate-y-2 hover:border-blue-500">

                  <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-2xl bg-blue-600 text-white shadow-lg shadow-blue-500/30">
                    {step.icon}
                  </div>
